...
CREATE TABLE `lastfm` (
  ...
  `lastfm_account` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lastfm`
--

LOCK TABLES `lastfm` WRITE;
/*!40000 ALTER TABLE `lastfm` DISABLE KEYS */;
/*!40000 ALTER TABLE `lastfm` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-04-08  0:17:28
